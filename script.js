...
const gameLogicController = (function() {
    const playerOne = (playerName, playerMark) => createPlayer(selectedName, selectedMark);
    const playerTwo = (playerName, playerMark) => createPlayer(selectedName, selectedMark);
